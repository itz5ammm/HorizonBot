...
module.exports = {
  ...
  execute: async (client, message, args, color, prefix) => {
    const shipped =
    ...
    const { body } = await get(
      `https://nekobot.xyz/api/imagegen?type=ship&user1=${shipper.user.displayAvatarURL}&user2=${shipped.user.displayAvatarURL}`
    );
